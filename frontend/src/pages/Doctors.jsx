...
const Doctors = () => {
  ...
  const DoctorSkeleton = () => (
    <div className="border border-indigo-200 rounded-xl overflow-hidden animate-pulse max-sm:w-2/3 max-sm:m-auto">
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <button
          ...
          className={`sm:hidden py-1 px-3 border border-zinc-300 rounded text-sm transition-all ${
        ...
        >
          ...
          <li
            ...
            className={`w-[94vw] sm:w-auto pr-16 pl-3 py-1.5 border border-gray-300 rounded transition-all cursor-pointer ${
