...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      formData.append(
        "address",
        JSON.stringify({ line1: addressL1, line2: addressL2 })
      );
      ...
      <div className="bg-white  px-8 py-8 border border-zinc-200 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <input
                ...
                value={name}
                className="border border-zinc-200 rounded px-3 py-2"
                type="text"
                placeholder="Name"
                required
              />
            ...
            <div className="flex-1 flex flex-col gap-1">
              ...
              <select
                ...
                value={experience}
                className="border border-zinc-200 rounded px-2 py-2"
              >
        ...
        <div>
          ...
          <textarea
            ...
            value={about}
            className="w-full px-4 pt-2 border border-zinc-200 rounded"
            rows={5}
